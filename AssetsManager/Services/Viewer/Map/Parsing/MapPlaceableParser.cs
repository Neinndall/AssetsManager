...
namespace AssetsManager.Services.Viewer.Map.Parsing
{
    ...
    internal sealed class MapPlaceableParser
    {
        ...
        internal static string ReadName(IReadOnlyDictionary<uint, BinTreeProperty> properties)
        {
            ...
            {
                BinTreeString text => text.Value ?? string.Empty,
                BinTreeHash hash => Hex(hash.Value),
                _ => string.Empty
            };
        }
